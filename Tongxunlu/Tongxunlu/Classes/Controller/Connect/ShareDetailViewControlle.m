...
- (void)searchBarSearchButtonClicked:(UISearchBar *)searchBar
{
    ...
    [[EZRequest instance]postDataWithPath:@"/txlshare-manage/mobile/shareBookUser/mobileSearch.txl" params:@{@"outUserId":@"7",@"compCode":compCode,@"filter.sbName":keyword,@"filter.sbId":[NSString stringWithFormat:@"%d",self.sbId]} success:^(NSDictionary *result) {
